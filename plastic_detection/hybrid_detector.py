"""
=============================================================================
 HYBRID PLASTIC WASTE DETECTION — Multi-Model Pipeline
=============================================================================

 Three-stage detection pipeline integrating multiple pre-trained models for
 high-accuracy plastic waste classification and resin type identification.

 Architecture:
   Stage 1: Waste Detection    (SSDLite320-MobileNetV3 / YOLO fallback)
   Stage 2: Resin Classification (MobileNetV3-Small plastic type classifier)
   Stage 3: Result Aggregation   (combine detection + classification + metadata)

 Fallback chain:
   TACO → Detectron2-trash → YOLO (original) → rule-based

 Usage:
   from hybrid_detector import HybridPlasticDetector
   detector = HybridPlasticDetector()
...
# ─── TACO waste categories ──────────────────────────────────────────────────
# Based on the TACO dataset (https://github.com/pedropro/TACO).
# The 60 original categories are grouped into 10 super-categories for
# practical detection.  Each maps to a plastic material classification.
...
# Fine-grained TACO class list (60 categories from the TACO annotations)
TACO_CLASSES = [
    "__background__",
    "Aluminium foil",
    "Battery",
...
# Map each TACO class → plastic material info.
# Classes that are NOT plastic get is_plastic=False so downstream
# classification can still display them as "non-plastic waste".
TACO_TO_MATERIAL: dict[str, dict] = {
    ...
    "Other plastic bottle": {
        ...
        "resin_code": 2,
        "recyclable": True,
        "description": "Opaque plastic bottle — likely HDPE, recyclable",
    },
    "Clear plastic bottle": {
        "item_type": "Plastic Bottle",
        "is_plastic": True,
        ...
        "resin_code": 1,
        "recyclable": True,
        "description": "Clear PET bottle — most commonly recycled plastic",
    },
    "Glass bottle": {
        ...
        "resin_code": 0,
        "recyclable": True,
        "description": "Glass bottle — recyclable, not plastic",
    },
    # ── Bottle Caps ──
    "Plastic bottle cap": {
        "item_type": "Plastic Bottle Cap",
        "is_plastic": True,
        "material": "PP",
        "resin_code": 5,
        "recyclable": True,
        "description": "Polypropylene bottle cap — recyclable",
    },
    "Metal bottle cap": {
        "item_type": "Metal Bottle Cap",
        "is_plastic": False,
        "material": "METAL",
        "resin_code": 0,
        "recyclable": True,
        "description": "Metal bottle cap — recyclable, not plastic",
    },
    # ── Bags & Wrappers ──
    "Single-use carrier bag": {
        "item_type": "Plastic Carrier Bag",
        "is_plastic": True,
        "material": "LDPE",
        "resin_code": 4,
        "recyclable": True,
        "description": "LDPE single-use carrier bag — recyclable at drop-off",
    },
    "Polypropylene bag": {
        "item_type": "Polypropylene Bag",
        "is_plastic": True,
        "material": "PP",
        "resin_code": 5,
        "recyclable": True,
        "description": "Polypropylene woven bag — recyclable",
    },
    "Garbage bag": {
        "item_type": "Garbage Bag",
        "is_plastic": True,
        "material": "LDPE",
        "resin_code": 4,
        "recyclable": False,
        "description": "LDPE garbage bag — NOT recyclable (contaminated)",
    },
    "Paper bag": {
        "item_type": "Paper Bag",
        "is_plastic": False,
        ...
        "resin_code": 0,
        "recyclable": True,
        "description": "Paper bag — recyclable, not plastic",
    },
    "Plastified paper bag": {
        "item_type": "Plastified Paper Bag",
        "is_plastic": True,
        "material": "OTHER",
        "resin_code": 7,
        "recyclable": False,
        "description": "Paper bag with plastic lining — NOT recyclable",
    },
    "Plastic film": {
        "item_type": "Plastic Film",
        "is_plastic": True,
        "material": "LDPE",
        "resin_code": 4,
        "recyclable": True,
        "description": "LDPE plastic film/wrap — recyclable at drop-off",
    },
    "Other plastic wrapper": {
        "item_type": "Plastic Wrapper",
        "is_plastic": True,
        "material": "LDPE",
        "resin_code": 4,
        "recyclable": False,
        "description": "Mixed plastic wrapper — check local recycling rules",
    },
    "Crisp packet": {
        "item_type": "Crisp/Chip Packet",
        "is_plastic": True,
        "material": "OTHER",
        "resin_code": 7,
        "recyclable": False,
        "description": "Multi-layer metallised film — NOT recyclable",
    },
    "Six pack rings": {
        "item_type": "Six Pack Rings",
        "is_plastic": True,
        "material": "LDPE",
        "resin_code": 4,
        "recyclable": True,
        "description": "LDPE six-pack rings — recyclable, hazardous to wildlife",
    },
    # ── Cups ──
    "Disposable plastic cup": {
        "item_type": "Disposable Plastic Cup",
        "is_plastic": True,
        "material": "PP",
        "resin_code": 5,
        "recyclable": True,
        "description": "Polypropylene disposable cup — recyclable",
    },
    "Foam cup": {
        "item_type": "Foam/Styrofoam Cup",
        "is_plastic": True,
        "material": "PS",
        "resin_code": 6,
        "recyclable": False,
        "description": "Expanded polystyrene cup — NOT recyclable",
    },
    "Glass cup": {
        "item_type": "Glass Cup",
        "is_plastic": False,
        ...
        "resin_code": 0,
        "recyclable": True,
        "description": "Glass cup — recyclable, not plastic",
    },
    "Other plastic cup": {
        ...
        "resin_code": 6,
        "recyclable": False,
        "description": "Polystyrene cup — often NOT recyclable",
    },
    "Paper cup": {
        "item_type": "Paper Cup",
        "is_plastic": True,
        ...
        "resin_code": 7,
        "recyclable": False,
        "description": "Paper cup with plastic lining — NOT recyclable",
    },
    # ── Containers ──
    "Disposable food container": {
        "item_type": "Disposable Food Container",
        "is_plastic": True,
        "material": "PP",
        "resin_code": 5,
        "recyclable": True,
    ...
    "Foam food container": {
        "item_type": "Foam Food Container",
        "is_plastic": True,
        "material": "PS",
        "resin_code": 6,
        "recyclable": False,
        "description": "Expanded polystyrene container — NOT recyclable",
    },
    "Other plastic container": {
        ...
        "resin_code": 2,
        "recyclable": True,
        "description": "HDPE container — recyclable curbside",
    },
    "Spread tub": {
        "item_type": "Spread Tub",
        "is_plastic": True,
        "material": "PP",
        "resin_code": 5,
        "recyclable": True,
        "description": "Polypropylene tub (butter/margarine) — recyclable",
    },
    "Tupperware": {
        "item_type": "Tupperware",
        "is_plastic": True,
        "material": "PP",
        "resin_code": 5,
        "recyclable": True,
        "description": "Polypropylene reusable container — recyclable",
    },
    "Plastic lid": {
        "item_type": "Plastic Lid",
        "is_plastic": True,
        "material": "PP",
        "resin_code": 5,
        "recyclable": True,
        "description": "Polypropylene lid — recyclable with container",
    },
    "Metal lid": {
        "item_type": "Metal Lid",
        "is_plastic": False,
        ...
        "resin_code": 0,
        "recyclable": True,
        "description": "Metal lid — recyclable, not plastic",
    },
    # ── Cutlery & Straws ──
    "Plastic utensils": {
    ...
    "Plastic straw": {
        "item_type": "Plastic Straw",
        "is_plastic": True,
        "material": "PP",
        "resin_code": 5,
        "recyclable": False,
        "description": "Polypropylene straw — NOT recyclable (too small)",
    },
    "Paper straw": {
        "item_type": "Paper Straw",
        "is_plastic": False,
        "material": "PAPER",
        "resin_code": 0,
        "recyclable": True,
        "description": "Paper straw — compostable, not plastic",
    },
    "Squeezable tube": {
        "item_type": "Squeezable Tube",
        "is_plastic": True,
        "material": "LDPE",
        "resin_code": 4,
        "recyclable": False,
        "description": "LDPE squeeze tube — NOT recyclable (mixed materials)",
    },
    "Plastic gloves": {
        "item_type": "Plastic Gloves",
        "is_plastic": True,
        "material": "OTHER",
        "resin_code": 7,
        "recyclable": False,
        "description": "Latex/nitrile gloves — NOT recyclable",
    },
    # ── Foam & Styrofoam ──
    "Styrofoam piece": {
        "item_type": "Styrofoam Piece",
        "is_plastic": True,
        "material": "PS",
        "resin_code": 6,
        "recyclable": False,
        "description": "Expanded polystyrene fragment — NOT recyclable",
    },
    # ── Other Plastic ──
    "Other plastic": {
        "item_type": "Other Plastic",
        "is_plastic": True,
        "material": "OTHER",
        "resin_code": 7,
        "recyclable": False,
        "description": "Unidentified plastic — check for recycling symbol",
    },
    "Rope & strings": {
        "item_type": "Rope/String",
        "is_plastic": True,
        "material": "PP",
        "resin_code": 5,
        "recyclable": False,
        "description": "Polypropylene rope/string — NOT recyclable",
    },
    # ── Non-Plastic Waste ──
    "Aluminium foil": {
        "item_type": "Aluminium Foil",
        "is_plastic": False,
        "material": "METAL",
        "resin_code": 0,
        "recyclable": True,
        "description": "Aluminium foil — recyclable if clean",
    },
    "Battery": {
        "item_type": "Battery",
        "is_plastic": False,
        ...
        "resin_code": 0,
        "recyclable": False,
        "description": "Battery — hazardous waste, special disposal required",
    },
    "Aluminium blister pack": {
        "item_type": "Blister Pack",
        "is_plastic": True,
        "material": "OTHER",
        "resin_code": 7,
        "recyclable": False,
        "description": "Plastic/aluminium blister pack — NOT recyclable",
    },
    "Carded blister pack": {
        "item_type": "Carded Blister Pack",
        "is_plastic": True,
        "material": "PVC",
        "resin_code": 3,
        "recyclable": False,
        "description": "PVC blister pack — NOT recyclable",
    },
    "Broken glass": {
        "item_type": "Broken Glass",
        "is_plastic": False,
        "material": "GLASS",
        "resin_code": 0,
        "recyclable": False,
        "description": "Broken glass — NOT recyclable (safety hazard)",
    },
    "Food Can": {
        "item_type": "Food Can",
        "is_plastic": False,
        ...
        "resin_code": 0,
        "recyclable": True,
        "description": "Tin/steel food can — recyclable",
    },
    "Aerosol": {
        "item_type": "Aerosol Can",
        "is_plastic": False,
        "material": "METAL",
        "resin_code": 0,
        "recyclable": True,
        "description": "Aerosol can — recyclable if empty",
    },
    "Drink can": {
        "item_type": "Drink Can",
        "is_plastic": False,
        ...
        "resin_code": 0,
        "recyclable": True,
        "description": "Aluminium drink can — highly recyclable",
    },
    "Glass jar": {
        "item_type": "Glass Jar",
        "is_plastic": False,
        ...
        "resin_code": 0,
        "recyclable": True,
        "description": "Glass jar — recyclable",
    },
    "Pop tab": {
        "item_type": "Pop Tab",
        "is_plastic": False,
        ...
        "resin_code": 0,
        "recyclable": True,
        "description": "Aluminium pop tab — recyclable with can",
    },
    "Scrap metal": {
        "item_type": "Scrap Metal",
        "is_plastic": False,
        "material": "METAL",
        "resin_code": 0,
        "recyclable": True,
        "description": "Scrap metal — recyclable at metal recyclers",
    },
    # ── Paper & Cardboard ──
    "Toilet tube": {
        "item_type": "Toilet Tube",
        "is_plastic": False,
        "material": "PAPER",
        "resin_code": 0,
        "recyclable": True,
        "description": "Cardboard tube — recyclable",
    },
    "Other carton": {
        "item_type": "Carton",
        "is_plastic": False,
        ...
        "resin_code": 0,
        "recyclable": True,
        "description": "Carton/cardboard — recyclable",
    },
    "Egg carton": {
        "item_type": "Egg Carton",
        "is_plastic": False,
        "material": "PAPER",
        "resin_code": 0,
        "recyclable": True,
        "description": "Paper/cardboard egg carton — recyclable",
    },
    "Drink carton": {
        "item_type": "Drink Carton",
        "is_plastic": True,
        "material": "OTHER",
        "resin_code": 7,
        "recyclable": True,
        "description": "Tetra Pak drink carton — recyclable at special facilities",
    },
    "Corrugated carton": {
        "item_type": "Corrugated Carton",
        "is_plastic": False,
        "material": "PAPER",
        "resin_code": 0,
        "recyclable": True,
        "description": "Corrugated cardboard — recyclable",
    },
    "Meal carton": {
        "item_type": "Meal Carton",
        "is_plastic": False,
        "material": "PAPER",
        "resin_code": 0,
        "recyclable": True,
        "description": "Cardboard meal carton — recyclable if clean",
    },
    "Pizza box": {
        "item_type": "Pizza Box",
        "is_plastic": False,
        ...
        "resin_code": 0,
        "recyclable": False,
        "description": "Pizza box — NOT recyclable if greasy",
    },
    "Magazine paper": {
        "item_type": "Magazine Paper",
        "is_plastic": False,
        "material": "PAPER",
        "resin_code": 0,
        "recyclable": True,
        "description": "Magazine paper — recyclable",
    },
    "Tissues": {
        "item_type": "Tissues",
        "is_plastic": False,
        ...
        "resin_code": 0,
        "recyclable": False,
        "description": "Tissues — NOT recyclable (contaminated)",
    },
    "Wrapping paper": {
        "item_type": "Wrapping Paper",
        "is_plastic": False,
        "material": "PAPER",
        "resin_code": 0,
        "recyclable": False,
        "description": "Wrapping paper — NOT recyclable (coated/glittered)",
    },
    "Normal paper": {
        "item_type": "Paper",
        "is_plastic": False,
        ...
        "resin_code": 0,
        "recyclable": True,
        "description": "Normal paper — recyclable",
    },
    # ── Other ──
    "Food waste": {
        "item_type": "Food Waste",
        "is_plastic": False,
        "material": "ORGANIC",
        "resin_code": 0,
        "recyclable": False,
        "description": "Food waste — compostable, not recyclable",
    },
    "Shoe": {
        "item_type": "Shoe",
        "is_plastic": False,
        ...
        "resin_code": 0,
        "recyclable": False,
        "description": "Shoe — NOT recyclable in standard waste",
    },
    "Cigarette": {
        "item_type": "Cigarette Butt",
        "is_plastic": True,
        "material": "OTHER",
        "resin_code": 7,
        "recyclable": False,
        "description": "Cigarette filter (cellulose acetate) — NOT recyclable",
    },
    "Unlabeled litter": {
        "item_type": "Unlabeled Litter",
        "is_plastic": False,
        "material": "OTHER",
        "resin_code": 0,
        "recyclable": False,
        "description": "Unidentified litter — check manually",
    },
}

# ─── TrashNet class labels ───────────────────────────────────────────────────
TRASHNET_CLASSES = ["glass", "paper", "cardboard", "plastic", "metal", "trash"]

# ─── Resin type labels for the classifier ────────────────────────────────────
...
# ─── COCO class IDs that correspond to "waste-like" objects ──────────────────
# torchvision's COCO-pretrained models use class IDs 1-90
...
try:
    import torch
    HAS_TORCH = True
    log.debug("PyTorch %s available", torch.__version__)
except ImportError:
    log.debug("PyTorch not installed — hybrid detection unavailable")

try:
    import torchvision
    from torchvision import transforms
    HAS_TORCHVISION = True
    log.debug("torchvision %s available", torchvision.__version__)
except ImportError:
    log.debug("torchvision not installed")

try:
    import detectron2
    HAS_DETECTRON2 = True
    log.debug("Detectron2 available")
except ImportError:
    log.debug("Detectron2 not installed — using torchvision fallback")


# ─── No-op decorator when torch is absent ────────────────────────────────────
def _no_grad_decorator(func):
    """Identity decorator used when PyTorch is not installed."""
    return func


def _torch_no_grad():
    """Return torch.no_grad if available, else a no-op decorator."""
    if HAS_TORCH:
...
# ─────────────────────────────────────────────────────────────────────────────
# STAGE 1: WASTE DETECTION (SSDLite320-MobileNetV3)
# ─────────────────────────────────────────────────────────────────────────────


class TACODetector:
    """
    Waste detector using SSDLite320-MobileNetV3 (torchvision implementation).

    Uses SSDLite with MobileNetV3-Large backbone — optimised for real-time
    CPU inference (~10-20x faster than Mask R-CNN ResNet50).

    Can load weights from:
    1. TACO project's trained .pth weights (custom SSD architecture)
    2. Custom-trained waste detection weights
    3. COCO pre-trained weights (default fallback)
    """

    # Maximum dimension for input frame — larger frames are downscaled
    # to this size before inference.  Dramatically improves CPU throughput.
    MAX_INPUT_DIM = 320

    def __init__(
        self,
        weights_path: Optional[str] = None,
        num_classes: int = 61,  # 60 TACO classes + background
    ...
    def _lazy_load(self) -> None:
        ...
        # SSDLite320 + MobileNetV3-Large: ~10-20x faster than Mask R-CNN on CPU
        ...
        if self._weights_path and os.path.isfile(self._weights_path):
            # Load custom TACO-trained weights
            ...
            # Fall back to COCO-pretrained SSDLite320
            if self._weights_path:
                log.warning(
                    "TACO weights not found at %s — using COCO-pretrained",
                    self._weights_path,
                )
            else:
    ...
    def detect(self, frame: np.ndarray) -> list[dict]:
        """
        Detect waste objects in a BGR frame.

        Returns list of dicts: {label, confidence, box (x,y,w,h), class_id}
        """
        self._lazy_load()
        ...
        # Invert scale for bounding boxes
    ...
    def is_available(self) -> bool:
        """Check if this detector can be loaded."""
        return HAS_TORCH and HAS_TORCHVISION


# ─────────────────────────────────────────────────────────────────────────────
# STAGE 2: RESIN TYPE CLASSIFIER (MobileNetV3-Small)
# ─────────────────────────────────────────────────────────────────────────────


class ResinClassifier:
    """
    Classifies cropped plastic waste images into 7 resin types:
      PET (#1), HDPE (#2), PVC (#3), LDPE (#4), PP (#5), PS (#6), OTHER (#7).

    Uses MobileNetV3-Small architecture — optimised for fast CPU inference
    (~5x faster than EfficientNet-B3, ~2 MB model vs ~48 MB).

    Without custom-trained weights, uses rule-based classification from
    TACO_TO_MATERIAL mapping (skips neural network entirely).
    """

    # Expected input size for MobileNetV3-Small
    INPUT_SIZE = 224
    ...
    def _lazy_load(self) -> None:
        ...
        if self._weights_path and os.path.isfile(self._weights_path):
            ...
            if self._weights_path:
                log.warning(
                    "Classifier weights not found at %s — using ImageNet backbone",
                    self._weights_path,
                )
            # Load MobileNetV3-Small with ImageNet weights, replace classifier head
            from torchvision.models import MobileNet_V3_Small_Weights
            self._model = mobilenet_v3_small(
                weights=MobileNet_V3_Small_Weights.DEFAULT
            )
            # Replace the classifier head for 7 resin types
            in_features = self._model.classifier[3].in_features
            self._model.classifier[3] = torch.nn.Linear(
                in_features, len(RESIN_LABELS)
            )
            self._has_trained_weights = False
        ...
        self._loaded = True
        log.info(
            "Resin classifier (MobileNetV3-Small) loaded on %s (trained=%s)",
    ...
    def classify(self, crop: np.ndarray) -> dict:
        """
        Classify a cropped BGR image into one of the 7 resin types.
        ...
        # Skip NN inference entirely when no trained weights — output
        # would be random anyway, and the forward pass costs ~20-40 ms.
...
# ─────────────────────────────────────────────────────────────────────────────
# STAGE 2b: TRASHNET CLASSIFIER (ResNet-50 fallback)
# ─────────────────────────────────────────────────────────────────────────────


class TrashNetClassifier:
    """
    Lightweight 6-class waste classifier based on TrashNet
    (https://github.com/garythung/trashnet).

    Classes: glass, paper, cardboard, plastic, metal, trash
    Architecture: MobileNetV3-Small (fast CPU inference)

    Used as fallback when the resin classifier is unavailable
    or to pre-filter whether an item is actually plastic before running
    the more expensive resin classifier.
    """
    ...
    def _lazy_load(self) -> None:
        ...
        if self._weights_path and os.path.isfile(self._weights_path):
            ...
            self._model = mobilenet_v3_small(
                num_classes=len(TRASHNET_CLASSES)
            )
            state_dict = torch.load(
                self._weights_path, map_location=self.device, weights_only=True
            )
            ...
            if self._weights_path:
                log.warning(
                    "TrashNet weights not found at %s — using ImageNet backbone",
                    self._weights_path,
                )
            from torchvision.models import MobileNet_V3_Small_Weights
            self._model = mobilenet_v3_small(
            ...
            # Replace final classifier layer for 6-class classification
            in_features = self._model.classifier[3].in_features
            self._model.classifier[3] = torch.nn.Linear(
                in_features, len(TRASHNET_CLASSES)
            )
            self._has_trained_weights = False
        ...
        self._loaded = True
        log.info(
            "TrashNet classifier (MobileNetV3-Small) loaded on %s (trained=%s)",
            self.device, self._has_trained_weights,
        )
    ...
    def classify(self, crop: np.ndarray) -> dict:
        """
        Classify a cropped BGR image into one of 6 waste categories.
        ...
        # Skip NN inference when no trained weights — output is random
        if not self._has_trained_weights:
...
class HybridPlasticDetector:
    ...
    Stage 1: Waste Detection    (SSDLite320-MobileNetV3 → YOLO fallback)
    Stage 2: Resin Classification (MobileNetV3-Small → TrashNet → rule-based)
    Stage 3: Result Aggregation  (combine + metadata)

    Fallback chain ensures the system always produces results even when
    ...
    def __init__(
        ...
        # YOLO fallback (reference to existing PlasticDetector)
        yolo_fallback=None,
        # General
        device: Optional["torch.device"] = None,
        # Performance
        ...
        # ── Frame-skip cache: only run heavy models every N frames ──
        self._frame_skip = max(1, frame_skip)
        self._frame_counter = 0
        self._cached_results: list[dict] = []

        # Resolve default weight paths
        ...
        # Determine device once for all models
        self._device = device
        if device is None and HAS_TORCH:
            self._device = _get_device()

        # Initialize model wrappers (lazy-loaded)
    ...
    def detect(self, frame: np.ndarray) -> list[dict]:
        """
        Run the full hybrid detection pipeline.

        Returns list of dicts in the standard format:
        {
            "label", "plastic_type", "item_type", "is_plastic",
            "material", "material_name", "resin_code", "recyclable",
            "description", "confidence", "box" (x,y,w,h),
        }

        Uses frame-skipping: heavy ML inference runs every N frames;
        intermediate frames reuse cached results for ~Nx speedup.
        """
        self._frame_counter += 1

        # Reuse cached results on skipped frames
        ...
        # ── STAGE 2 + 3: Classification & Aggregation ──
        results = []
    ...
    def _stage1_detect(self, frame: np.ndarray) -> list[dict]:
        """
        Stage 1: Detect waste objects in the frame.

        Tries TACO → YOLO fallback.
        """
        # Try SSDLite320/TACO first
        if self._taco:
            try:
        ...
        # Fall back to existing YOLO detector
        if self._yolo_fallback:
            try:
                yolo_results = self._yolo_fallback.detect(frame)
                # Convert YOLO results to raw detection format
                raw = []
                for det in yolo_results:
                    raw.append({
                        ...
                        # Carry forward YOLO's material info
    ...
    def _stage2_classify(self, frame: np.ndarray, detection: dict) -> dict:
        """
        Stage 2 + 3: Classify detected object and aggregate results.

        For each detection:
        1. Crop the detected region from the frame
        2. Run resin classifier (MobileNetV3-Small) on the crop
        3. Optionally pre-filter with TrashNet
        4. Aggregate detection + classification into final result
        """
        ...
        # ── Stage 2b: TrashNet pre-filter (only if classifier didn't run) ──
        ...
        if self._trashnet and crop.size > 0 and classifier_result is None:
            try:
                ...
                if trashnet_result.get("reliable"):
                    log.debug(
                        "Stage 2b: TrashNet classified '%s' as %s",
        ...
        return self._aggregate_result(
            detection, base_info, classifier_result, trashnet_result
        )

    def _get_base_material_info(self, label: str, source: str) -> dict:
        """
        Look up material info from TACO or COCO class name.
        """
        # Check TACO mapping first
        if label in TACO_TO_MATERIAL:
            return TACO_TO_MATERIAL[label].copy()

        # Check if it came from YOLO with pre-attached info
        # (handled in _aggregate_result via _yolo_info)

        # Default: assume plastic, unknown type
        return {
    ...
    def _aggregate_result(
        ...
        """
        Stage 3: Combine detection + classification + metadata into final result.

        Priority:
        1. Trained resin classifier result (if reliable)
        2. TrashNet is_plastic flag (if reliable)
        3. TACO/COCO mapping (base_info)
        4. YOLO fallback info
        """
        label = detection["label"]
        confidence = detection["confidence"]
        box = detection["box"]
        ...
        # Override with classifier result if reliable
        ...
        # Override is_plastic from TrashNet if reliable and base doesn't know
        ...
        # If source is YOLO fallback, use its pre-computed info as base
        yolo_info = detection.get("_yolo_info")
        if source == "yolo_fallback" and yolo_info:
            # Use YOLO info unless classifier overrode it
    ...
    def _get_plastic_category(item_type: str, is_plastic: bool) -> str:
        """Map item to high-level category."""
        if not is_plastic:
    ...
    # ── Drawing (same interface as PlasticDetector) ──

    @staticmethod
    def draw(frame: np.ndarray, detections: list[dict]) -> np.ndarray:
        """Draw bounding boxes with material info and recyclability on frame."""
        ...
        for det in detections:
            ...
            # Line 2: Material + resin code (or non-plastic label)
    ...
    def pipeline_status(self) -> dict:
        """Return status of each pipeline stage."""
        return {
